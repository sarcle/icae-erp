...
<!-- 				<span class="text-info"> - ADMINISTRADOR</span> <i class="fa fa-desktop text-warning"></i> -->
			...
			<blockquote>
				<p class="text-info">Selecciona un cliente para editarlo o agrega uno nuevo.</p>
			</blockquote>
			<hr>
			<div class="row">
				<pnw:successMessage/>
					...
					<div class="table-responsive">
						<display:table htmlId="clientes" id="cliente" name="${clientes}" 
 							...
 							<display:column title="Modificar" headerClass="text-primary text-center" class="text-center">
 								<a href="<c:url value="/facturacion/modifyCliente/${cliente.id}"/>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
 							</display:column>
 						</display:table>
					</div>
				</div>
