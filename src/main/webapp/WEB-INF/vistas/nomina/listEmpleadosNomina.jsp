...
<body>
	<div class="container main-content">
		<div class="white-panel row">
			<h2>
				<span class="text-warning">Módulo de nómina</span>
<!-- 				<span class="text-info"> - ADMINISTRADOR</span> <i class="fa fa-desktop text-warning"></i> -->
			</h2>
			<blockquote>
				<p class="text-info">Selecciona un empleado para editarlo o agrega uno nuevo.</p>
			</blockquote>
			<hr>
			<div class="row">
				<pnw:successMessage/>
			...
			<div class="text-center">
				<p>
					<a href="<c:url value="/nomina/admin/newEmpleadoNomina"/>" class="btn btn-primary" > <i class="fa fa-plus"></i> Agregar Empleado </a>
					<a id="timbarNomina" onclick = "$('#Searching_Modal').modal('show')" value="Show Modal"  href="<c:url value="/nomina/admin/timbrarNomina"/>" class="btn btn-success">TIMBRAR NOMINA <i class="fa fa-times"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="text-align: center">
                    <h3>TIMBRANDO NOMINA ...</h3>
                </div>
                <div class="modal-body" >
                    <div style="height:200px">
<!--                       <span id="searching_spinner_center" style="position: absolute;display: block;top: 50%;left: 50%;"></span> -->
                      <i class="fa fa-spinner fa-spin"  style="position: absolute;display: block;top: 40%;left: 40%; font-size:90px"></i>
                    </div>
                </div>
			...
			<div class="col-md-offset-1 col-md-10">
				<div class="panel panel-warning">
					...
					<div class="table-responsive">
						<display:table htmlId="empleados" id="empleado" name="${empleadosNomina}" 
 							...
 							<display:column title="A. Paterno" property="apellidoPaterno" headerClass="text-primary"/>
 							<display:column title="A. Materno" property="apellidoMaterno" headerClass="text-primary"/>
 							<display:column title="Curp" property="curp" headerClass="text-primary"/>
 							<display:column title="RFC" property="rfc" headerClass="text-primary"/>
 							<display:column title="Tipo Nómina" property="tipoNomina" headerClass="text-primary"/>
 							<display:column title="Dias pagados" property="diasPagados" headerClass="text-primary"/>
 							<display:column title="Modificar" headerClass="text-primary text-center" class="text-center">
 								<a href="<c:url value="/nomina/admin/modifyEmpleadoNomina/${empleado.id}"/>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
 							</display:column>
 						</display:table>
					</div>
				</div>
