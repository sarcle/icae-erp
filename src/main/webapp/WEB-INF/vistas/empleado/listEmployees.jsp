...
<body>
	<div class="container main-content">
		<div class="white-panel row">
			...
			<blockquote>
				<p class="text-info">Seleccion un usuario para editarlo o agrega uno nuevo.</p>
			</blockquote>
			<hr>
			<div class="row">
				<pnw:successMessage/>
			...
			<div class="text-center">
				<p>
					...
					<a id="cancelar" href="<c:url value="/nomina/menuPage"/>" class="btn btn-danger">Volver <i class="fa fa-times"></i></a>
				</p>
			</div>
